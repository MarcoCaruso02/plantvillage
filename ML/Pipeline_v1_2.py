...
def parameters_span(dataset_name):
    ...
    elif(dataset_name=="Alex_features.csv" or dataset_name=="features_Gabor_v6.csv"):
        par_span=[20,40,60,80]
    elif(dataset_name=="features_102_Alex.csv" or dataset_name=="features_102_Gabor_v6.csv"
         or dataset_name=="features_102_Gabor_v6_den.csv" or dataset_name=="features_102_Alex_den.csv"):
...
dataset_name="features_102_Alex.csv"
model_name="XGBOOST"
result_file="102+Alex-XGBOOST.txt"
#DATASET LOADING
